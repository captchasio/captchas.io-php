...
use Exception;
use CaptchasIO\Exception\ApiException;
use CaptchasIO\Exception\NetworkException;
use CaptchasIO\Exception\TimeoutException;
use CaptchasIO\Exception\ValidationException;
